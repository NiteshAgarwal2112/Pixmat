...
public class Bw
 {
        ...
        public static BufferedImage bwImage(BufferedImage image) throws IOException
            {
    ...
    for(int i=0; i<image.getWidth(); i++) {
        for(int j=0; j<image.getHeight(); j++) {
            ...
            newPixel = colorToRGB(alpha/2,newPixel, newPixel, newPixel);
   ...
   //ImageIO.write(avg_gray,"PNG",new File("c:/images/grayscale.png"));
   return avg_gray;
  }
